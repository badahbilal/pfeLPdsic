...
<div class="bg-light py-3">
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0"><a href="/">Acceuil</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">à propos de nous</strong></div>
        </div>
    </div>
</div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-6 offset-3">
                ...
                <div class="site-section-heading pt-3 mb-4">
                    <h2 class="text-black">A propos de nous</h2>
                </div>
